...
from django.template import loader # we not longer need this because we have another way! using just render
...
# def results(request, question_id):
#     question = get_object_or_404(Question, pk=question_id)
#     return render(request, 'calc/results.html', {'question': question})
...
def vote(request, question_id):
    ...
    try:
        ...
        return HttpResponseRedirect(reverse('calc:results', args=(question.id,)))